# Django settings for papayon_erp project.
import os
...
SECRET_KEY = '6e!46hrrb1a3l!q2(f%_hhijiq$cv@di0-(++j%zns4nu8yp6q'
...
ROOT_URLCONF = 'papayon_erp.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'papayon_erp.wsgi.application'
