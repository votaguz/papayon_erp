...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContactProvider'
        db.create_table(u'erp_contactprovider', (
            ...
            ('provider', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contacts', to=orm['erp.ProviderEntity'])),
            ('phone', self.gf('django.db.models.fields.CharField')(max_length=140)),
            ('document_id', self.gf('django.db.models.fields.CharField')(max_length=140)),
        ))
        db.send_create_signal(u'erp', ['ContactProvider'])
    ...
    def backwards(self, orm):
        # Deleting model 'ContactProvider'
        db.delete_table(u'erp_contactprovider')
