...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DocumentEntity.vigence'
        db.alter_column(u'erp_documententity', 'vigence', self.gf('django.db.models.fields.CharField')(max_length=140, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'DocumentEntity.vigence'
        raise RuntimeError("Cannot reverse this migration. 'DocumentEntity.vigence' and its values cannot be restored.")
